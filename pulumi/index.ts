...
export const coreVersion = config.releaseMetadata.coreVersion
export const coreTag = config.releaseMetadata.coreTag
export const componentsVersion = config.releaseMetadata.componentsVersion
export const componentsTag = config.releaseMetadata.componentsTag
