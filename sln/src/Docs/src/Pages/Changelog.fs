        ...
        { id = "changelog"
          ...
          nodes = [
            ...
            UnorderedList [
                ...
                [ Text "Release execution now verifies one package artifact, deploys and tests the matching Docs version and commit, publishes that exact artifact, and waits for NuGet availability." ];
