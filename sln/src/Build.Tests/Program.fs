...
let tests =
    testList "Package publishing" [
        ...
        test "Documentation is compiled from and distributed with the canonical source registry" {
            ...
            Expect.stringContains cliProject "EmbeddedResource Include=\"@(FveComponent);@(FveAsset)\"" "the CLI embeds registered Documentation styles"
            ...
            Expect.stringContains manifest "data-fve-app-mode-root" "Documentation owns the server-rendered App-mode presentation"
            ...
            Expect.isFalse (baseManifest.Contains(".spec-browser-frame")) "Browser presentation uses static utility classes"
            Expect.isFalse (baseManifest.Contains(".fve-phone")) "Phone presentation uses static utility classes"
