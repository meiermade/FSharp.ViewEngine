...
for optional_name in DOCS_EXPECTED_ENVIRONMENT DOCS_EXPECTED_IMAGE CORE_PACKAGE_VERSION CLI_PACKAGE_VERSION CF_ACCESS_CLIENT_ID CF_ACCESS_CLIENT_SECRET; do
