        ...
        _children [
            ...
            div [
                ...
                _children [
                    ...
                    a [
                        _href "/"
                        _class "text-sm font-semibold tracking-wider text-slate-700 dark:text-white"
                        _children "FSharp.ViewEngine"
                    ]
                ]
            ]
...
let layout (pageTitle: string) (currentPath: string) (content: string) =
    html [
        _lang "en"
        ...
        _children [
            head [
                ...
                title pageTitle
                script "let t=localStorage.getItem('theme');if(t==='dark'||(!t||t==='system')&&window.matchMedia('(prefers-color-scheme: dark)').matches){document.documentElement.classList.add('dark')}"
                link [ _rel "stylesheet"; _href "/css/output.css" ]
                script [ _src "https://unpkg.com/alpinejs@3.x.x/dist/cdn.min.js"; KeyValue ("defer", "true") ]
